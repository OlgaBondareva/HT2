...
public class DBWorker {
    ...
    public ResultSet getDBData(String query) {
        ...
        try {
            ...
            connect = DriverManager.getConnection("jdbc:mysql://localhost/phonebook?user=lorem&password=123456&useUnicode=true&characterEncoding=UTF-8&characterSetResults=utf8&connectionCollation=utf8_general_ci");
