...
<%
    ...
    error_message = jsp_parameters.get("Error Add Person");
%>
...
<form action="<%=request.getContextPath()%>/" method="post">
    ...
    <table align="center" border="1" width="70%">
        ...
        <tr>
            <td colspan="2" align="center"><a href="<%=request.getContextPath()%>/?action=return_to_list">Вернуться к списку</a></td>
        </tr>
    </table>
</form>
</body>
